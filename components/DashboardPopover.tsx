...
export function DashboardPopover({
  ...
  return (
    <div className={'flex flex-row justify-end right-80 z-10 relative w-full transform translate-x-20'}>
      <div
        className={
      ...
      >
        <Popover>
          <PopoverTrigger className="p-2 bg-blue-300 hover:bg-green-400 hover:text-white">Add New</PopoverTrigger>
