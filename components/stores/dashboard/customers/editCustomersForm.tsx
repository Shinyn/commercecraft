...
export function EditCustomerForm(customer: Customer) {
    ...
    const customerSchema = z.object({
        ...
        firstName: z.string().min(1, { message: 'Name must be at least 1 characters long' }).max(255, { message: 'Name must be less than 255 characters' }),
        lastName: z.string().min(1, { message: 'Name must be at least 1 characters long' }).max(255, { message: 'Name must be less than 255 characters' }),
        ...
        city: z.string().min(1, { message: 'City must be at least 1 characters long' }).max(255, { message: 'City must be less than 255 characters' }),
        phone: z.string().min(1, { message: 'Phone must be at least 1 characters long' }).max(255, { message: 'Phone must be less than 255 characters' }),
        e_mail: z.string().min(1, { message: 'E-mail must be at least 1 characters long' }).max(255, { message: 'E-mail must be less than 255 characters' }),
    ...
    function onSubmitting(values: z.infer<typeof customerSchema>) {
        ...
        axios
            .patch(`/api/${params.storeID}/customers/${id}`, { firstName, lastName, street, zipCode, city, e_mail, phone, numberOfOrders})
