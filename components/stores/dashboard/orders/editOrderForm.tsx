...
export function EditOrderForm(order: Order) {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    axios
      .patch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/${params.storeID}/orders/${id}`, {
        order_number,
        order_status,
        id,
      })
      ...
      <div className="p-2">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>This is your order ID, you can NOT change this.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            />
            <FormDescription>This is your customer information, you can not change this here.</FormDescription>
            <FormField
              control={form.control}
              name="order_status"
              render={({ field }) => (
